...
class Book{
    ...
    class Entry{
        ...
        Entry(String first, String last, String address, String  PINCODE){
            this.first = first;
            this.last = last;
    ...
    public void add(String first, String last, String address, String  PINCODE){
        if (entries<contents.length){
        contents[entries] = new Entry(first, last, address,  PINCODE);
        entries++;
        }
    ...
    public void edit(String first, String last, String address, String  PINCODE, int selection){
            ...
            for (int j = 0;j<contents.length;j++){
                switch(n){
                    ...
                    case 3:
                        ...
                        break;
                    case 4:
                        if (contents[i]. PINCODE.compareTo(contents[j]. PINCODE)<0){
                            Entry temp = contents[i];
                            contents[i] = contents[j];
                            contents[j] = temp;
                        }
